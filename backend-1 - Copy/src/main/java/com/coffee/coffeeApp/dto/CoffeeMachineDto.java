...
public class CoffeeMachineDto {
    ...
    public CoffeeMachineDto(Integer id, Integer facilityId, String status) {
        this.id = id;
    ...
    public Boolean getHasLowSugar() {
    	return hasLowSugar;
    }
    
    public void setHasLowSugar(Boolean hasLowSugar) {
    	this.hasLowSugar = hasLowSugar;
    }
