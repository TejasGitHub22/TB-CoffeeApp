...
//    private String alertType; // LOW_WATER, LOW_MILK, LOW_BEANS, MALFUNCTION, etc.
    ...
    public AlertLog(Integer machineId, String message) {
...
//    }
    ...
    public static AlertLog createLowWaterAlert(Integer machineId, float currentLevel) {
        ...
        return new AlertLog(machineId, message);
    }
    ...
    public static AlertLog createLowSugarAlert(Integer machineId, float currentLevel) {
        String message = String.format("Coffee sugar level is critically low: %.1f%%. Please refill immediately.", currentLevel);
        return new AlertLog(machineId, message);
    }
