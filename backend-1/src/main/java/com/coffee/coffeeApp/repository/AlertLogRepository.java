...
//    List<AlertLog> findCriticalAlerts();
    ...
    @Query("SELECT al FROM AlertLog al " +
           "WHERE al.isActive = true ORDER BY al.timestamp DESC")
    ...
    @Query("SELECT al FROM AlertLog al WHERE " +
           "al.timestamp >= :since AND al.isActive = true ORDER BY al.timestamp DESC")
...
//    Long countCriticalAlerts();
    ...
    // Count supply alerts
    @Query("SELECT COUNT(al) FROM AlertLog al WHERE al.isActive = true")
...
//                                     @Param("endTime") LocalDateTime endTime);
    ...
    void resolveAlertsByMachine(@Param("machineId") Integer machineId);
}