...
public class AlertLogDto {
    ...
    public AlertLogDto(Integer id, Integer machineId, String alertType, String message) {
        this.id = id;
    ...
    public static AlertLogDto createLowWaterAlert(Integer id, Integer machineId, float currentLevel) {
    ...
    public static AlertLogDto createLowMilkAlert(Integer id, Integer machineId, float currentLevel) {
    ...
    public static AlertLogDto createLowBeansAlert(Integer id, Integer machineId, float currentLevel) {
    ...
    public static AlertLogDto createMalfunctionAlert(Integer id, Integer machineId, String issue) {
